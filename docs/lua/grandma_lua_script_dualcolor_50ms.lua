...
-- Sends ALL data as ONE OSC message: page + fader values (0-100) + dual color values
-- Primary colors from 201-210, Secondary colors from 101-110
-- 
-- CONFIGURATION:
...
-- Configure executors to watch: faders 201-210 AND 101-110 for dual color support
for i = 201, 210 do
...
local function main()
    ...
    Printf("start pam OSC main() - watching faders 201-210 (values) + 201-210,101-110 (dual colors)")
    ...
    while (GetVar(GlobalVars(), "opdateOSC")) do
        ...
        if dataChanged or forceReload then
            ...
            -- Format: /faderUpdate,iiiiiiiiiiissssssssss,PAGE,F201,F202...F210,C201+C101,C202+C102...C210+C110
            ...
            Printf("Sent fader update: Page " .. destPage .. " with all fader (0-100) and dual color data")
        end
